      ...
      <ScrollView
        ...
        <View className="px-6 pb-2">
          <View className="flex-row items-start justify-between">
            ...
            {!isClosed && (
              <DropdownMenu>
                {/* TIP: If <Button> is a custom component, you usually need to add 'asChild' to the trigger so it doesn't swallow touch events */}
                ...
                <DropdownMenuContent>
                  {/* FIX: Use a ternary operator to return null instead of a boolean */}
